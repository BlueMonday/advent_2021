...
count_increase([_First | Rest], A) ->
    count_increase(Rest, A).
...
count_three_increase([_First | Rest], A) ->
    count_three_increase(Rest, A).
...
main([InputFilename]) ->
    ...
    IntegerList = lists:map(fun binary_to_integer/1, Lines),
